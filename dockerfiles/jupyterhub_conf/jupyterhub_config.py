...
c.DockerSpawner.container_image = os.environ['NOTEBOOK_IMAGE']
...
network_name = os.environ['NETWORK']
...
isis_data = os.environ.get('ISISDATA')
preset_notebooks = os.environ.get('SHARED')
c.DockerSpawner.volumes = { 'jupyterhub-user-{username}':notebook_dir,
                            isis_data:'/isis/data',
...
c.JupyterHub.hub_port =int(os.environ['NOTEBOOK_PORT'])
